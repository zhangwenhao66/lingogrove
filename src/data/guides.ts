...
export const guides: Guide[] = [
		...
		sections: [
			{
				...
				body: [
					...
					'The reason English speakers default to translating word-for-word is that "for" does not map cleanly onto either *por* or *para* on its own. The fix is to stop translating and start asking what role the phrase is playing: is it pointing at a goal, or is it pointing at a cause? *Para* points forward, at where something is headed. *Por* points backward or sideways, at why or how or through what something happens. Spanish draws a comparably sharp, easy-to-miss line among its own small connecting words, too: [Spanish conjunctions](/spanish-conjunctions/) covers why pero and sino aren\'t interchangeable translations of "but," a distinction English collapses into one word the same way it collapses por and para into "for."',
				],
			},
			{
		...
		sections: [
			{
				...
				body: [
					...
					'A shortened, casual version is common in speech and texting: *¡Feliz cumple!* drops the second half of *cumpleaños* much the way an English speaker might text "HBD" and skip typing the whole phrase.',
		...
		faq: [
			{
				...
				answer: 'No. Every country that speaks Spanish uses the same words for the greeting. What varies is the surrounding birthday tradition, like Mexico\'s Las Mañanitas, not the greeting.',
			},
			{
				question: 'What does "cumpleaños" literally mean?',
				answer: '"Years completed" or "fulfills years": it comes from cumplir ("to complete, to fulfill") plus años ("years"). Spain\'s official dictionary marks the date a person was born, counted year by year.',
			},
			{
				question: 'Is there a casual, shortened way to say it?',
				answer: 'Yes. "¡Feliz cumple!" trims the word down, similar to how English speakers might shorten a greeting in casual speech or texting.',
			},
			{
				question: 'Is Las Mañanitas the same song as the Spanish "Happy Birthday to You"?',
				answer: 'No, they\'re different songs. A Spanish version of the well-known English birthday tune does exist, sung casually in a handful of countries. Las Mañanitas is older and unrelated in origin, tracing back to a Sephardic serenade style that later became Mexico\'s corrido tradition, and it\'s the one Mexican families actually sing.',
			},
			{
				question: 'What does "feliz cumple, crack" mean?',
				answer: 'It means something like "happy birthday, champ" or "happy birthday, legend." Crack has nothing to do with breaking or drugs here: Spain\'s national dictionary added a separate entry for it as a borrowed English word meaning a person who stands out remarkably at something, on top of an older sense limited to standout racehorses and athletes. Linguists writing for The Conversation trace the broadening from horses that won races, to star athletes (the Argentine press was already calling Diego Maradona a crack by 1982), to anyone excellent at anything. Tacking it onto a birthday message turns an ordinary greeting into a compliment, not an insult.',
			},
		],
		sources: [
			...
			{ label: 'The Conversation: "Los \'cracks\' del diccionario: historia y uso de una palabra contradictoria"', url: 'https://theconversation.com/los-cracks-del-diccionario-historia-y-uso-de-una-palabra-contradictoria-219146' },
		],
	},
	{
	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				body: [
					'There\'s a lighter step below even *te quiero* for early romantic interest: *me gustas* ("I like you," in the sense of "I\'m into you," not the plain-liking sense of *[me gusta](/verbs-like-gustar/)* for a food or a movie). It signals attraction without committing to anything like love, closer to a crush confession than a relationship milestone. It\'s often what gets said before either *te quiero* or *te amo* is even on the table.',
	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				body: [
					'The indirect object answers "to whom?" or "for whom?": the recipient or beneficiary of the action, not the thing being acted on. The forms are *me, te, le, nos, os, les*, and unlike *lo/la*, they don\'t change for gender: *le* covers "to/for him," "to/for her," and "to/for you (formal)" alike. It is also the pronoun that marks the person with [verbs like gustar](/verbs-like-gustar/), where the thing liked, not the person, is the subject.',
					'*Escribo una carta a mi hermano.* → *Le escribo una carta.* (I write him a letter.) Notice the letter itself isn\'t what *le* refers to; *le* points at the person receiving it. Spanish also commonly keeps the explicit *a + noun* phrase alongside the pronoun even though it looks redundant to an English speaker: *Le doy el regalo a mi madre* keeps both *le* and *a mi madre*, a real feature of Spanish (clitic doubling) rather than a mistake or an emphasis device. A similar one-word-covers-several-jobs pattern shows up in [Spanish question words](/spanish-question-words/), where English "what" maps onto two different words, qué and cuál, and picking the wrong one is exactly the kind of error a lo/la versus le/les mistake also is: not a vocabulary gap, but a distinction English simply never forces a speaker to make.',
				],
				image: {
		...
		faq: [
			{
				...
				answer: '*Lo, la, los,* and *las* fill in for whatever a verb targets directly, and their gender and number have to mirror that target: *Compro el libro* → *Lo compro*. *Le* and *les*, by contrast, stand for whoever benefits from or is on the receiving end of the action, and their spelling stays fixed no matter the gender: *Doy el libro a mi hermana* → *Le doy el libro*. Outside the third person, the two sets even share identical forms, which is exactly why beginners conflate them.',
			},
			{
				question: 'Why does "le" turn into "se" in sentences like "se lo doy"?',
				answer: 'Spanish has no spoken slot for a third-person indirect pronoun immediately followed by a third-person direct one; that particular pairing was phased out of the language centuries ago. Wherever grammar would otherwise put them side by side, *se* steps in instead: *Le doy el libro* plus *lo doy* turns into *Se lo doy*, meaning "I give it to her, him, or them," and never *Le lo doy*. This substitution is automatic and has nothing to do with reflexive "se."',
			},
			{
				question: 'Is leísmo actually correct Spanish, or is it a mistake?',
				answer: 'It depends which direction it goes. The RAE tolerates swapping in *le* where a singular, masculine *lo* would normally name a person as the direct object, as in *A Juan le vi*, and treats that swap as a legitimate regional variant especially common in Spain. Going the other way is never accepted: *laísmo* puts *la/las* where that role calls for something else, and *loísmo* does the same with *lo/los*; the RAE counts both as errors, in every region alike.',
			},
			{
				question: 'How do you know whether to use "lo" or "le" in a specific sentence?',
				answer: 'Ask what role the pronoun is playing. If it names precisely what the verb targets (answering "what?" or "whom?"), reach for *lo/la* (or *los/las* for plural), matched to that target\'s own number and gender. Naming who benefits or is affected instead (answering who the action is aimed at or done on behalf of) calls for *le* (or *les*), a spelling that never shifts for gender.',
			},
		],
		sources: [
		...
		faq: [
			{
				...
				answer: 'It packs both the thing involved and whoever ends up with it into a single clause: one pronoun stands in for the thing itself (lo, la, los, las) and a second stands in for who it\'s going to (me, te, le/se, nos, os, les/se), so the sentence carries two pronouns where a fuller version would carry two noun phrases. Doy el regalo a mi hermano turns into Se lo doy, with se marking mi hermano and lo marking el regalo.',
			},
			{
				question: 'Does the le-to-se swap change the pronoun order, or just the pronoun itself?',
				answer: 'Just the pronoun. Se steps in for le or les whenever a third-person recipient pronoun would end up positioned right beside a third-person stand-in for the thing itself, but it keeps the exact same top-ranked slot that le or les held. Se lo doy keeps se ahead of lo for the same structural reason te lo doy keeps te ahead of lo: the RAE\'s hierarchy fixes which rank comes first, and the swap only changes which word fills that rank, not where the rank sits.',
			},
			{
				question: 'What order do double object pronouns follow in Spanish?',
				answer: 'The RAE puts se at the very top of the list, outranking everything else. Below that, a second-person form beats a first-person one, and a first-person form beats a third-person one; and once you\'re comparing pronouns from the same person, the one for who receives something outranks the one for the thing received. Working through those tiers always puts the who-receives-it pronoun ahead of the thing-received pronoun, never the other way round: te lo and se la are grammatical, lo te and la se are not.',
			},
			{
				question: 'Do double object pronouns attach to the verb or go in front of it?',
				answer: 'Both, depending on the verb form. When the verb is conjugated, both pronouns sit right before it (Te lo doy, No me lo digas); when it takes the shape of an infinitive, a gerund, or a command telling someone to do something, they fuse onto the end as one written word (Dámelo, Estoy dándoselo), which almost always adds a written tilde so the stress doesn\'t drift. Turn the command negative, though, and both pronouns snap back to the front: No me lo des, never No dámelo.',
			},
		],
		sources: [
		...
		sections: [
			{
				...
				body: [
					'English gets by with roughly two article choices: "the" for something specific, "a/an" (or nothing at all) for everything else. French runs a finer grid. Larousse\'s own dictionary defines the article as a word that precedes a noun and determines it "more or less precisely," while also marking its gender and number. In French, that grid runs three degrees deep, not the two English speakers are used to.',
			...
			},
			{
				...
				body: [
					...
					'Once a noun lands in the indefinite camp, not the definite one, French then asks a second question English doesn\'t grammaticalize the same way: is this something you count, or something you measure? Un chat, deux chats: cats are countable, so the indefinite article (un, une, plural des) applies. Pain, eau, and vin aren\'t normally counted one by one in ordinary speech, so they take the partitive (du pain, de l\'eau, du vin) instead, marking a portion of a mass, not a tally of separate items. Elle mange du pain ("She\'s eating [some] bread") describes an unspecified amount of bread, not "a bread" as a countable unit; that reading exists in French too (une baguette, un pain), but it requires switching to a noun that names a specific countable shape.',
				],
			},
			{
		...
		sections: [
			...
			},
			{
				...
				body: [
					...
					'The reason is historical rather than arbitrary: mi, tu, and su are apocopated (shortened) forms of the longer possessives mío, tuyo, and suyo, which do carry full gender marking when they appear after a noun or stand alone (la casa es mía, not mío). The written accent matters here too: mi (the possessive) and [mí](/spanish-accent-marks/) (the stressed pronoun meaning "for me," used after a preposition) are one of the closed set of diacritical tilde pairs, where the accent mark is the only thing telling two identically spelled words apart. The difference isn\'t only on paper. Mí carries real stress in speech, while mi, like most possessives placed before a noun, doesn\'t; writing mí hermano instead of mi hermano puts the accent on the wrong word entirely, not just a typo a reader would gloss over. That kind of near-invisible marking has a parallel one tense over: [the Spanish present tense](/spanish-present-tense-endings/) is the one tense RAE\'s own grammar treats as carrying no audible time marker at all, unlike the accent-bearing possessive pair above, where a single written stroke is the entire difference between two words.',
				],
			},
			{
		...
		faq: [
			{
				...
				answer: 'All three groups swap the dictionary-form stem for a new one, then take the same six person-endings across yo through ellos. The only structural difference is the vowel or consonant in the new stem: u-stem verbs like estar and tener get a stem containing u (estuv-, tuv-); i-stem verbs like hacer and querer get one containing i (hic-, quis-); j-stem verbs like decir and traer get one containing j (dij-, traj-), and that group alone loses a vowel in the ellos ending.',
			},
			{
				question: 'Why is "dijeron" correct instead of "dijieron"?',
				answer: 'Decir belongs to the j-stem family (along with traer and every -ducir verb); that group alone breaks the shared -ieron ending, taking -eron instead and dropping the i. That gives decir a third-person plural of dijeron, traer a matching trajeron, and conducir a matching condujeron, each missing the i that a regular -ieron would supply.',
			},
			{
				question: 'Do -ar and -er stem-changing verbs also change in the preterite?',
				answer: 'No. A verb like pensar or volver only shifts its stem when it\'s conjugated in the present; every one of its preterite forms follows the plain -ar/-er pattern with no exceptions. Only -ir verbs with a stem change (pedir, dormir, sentir) bring that shift into the preterite too, and even then only in the singular él/ella/usted form and the plural ellos, ellas, and ustedes form, leaving nosotros, vosotros, tú, and yo untouched.',
			},
			{
				question: 'Are dar and ver irregular in the preterite?',
				answer: 'Yes, though not for the same reason as the stem-family verbs above. Dar, technically an -ar verb, takes the same six person-endings as an -er/-ir verb but drops every accent, giving di for yo and dio for él/ella. Ver\'s forms carry no accent either, but for another reason entirely: its stem is a single letter, so there\'s no vowel cluster left to mark, producing vi for yo and vio for él/ella. Neither verb involves a changed stem the way estar → estuve or hacer → hice does.',
			},
			{
				question: 'How do you tell "fui" the ir-verb from "fui" the ser-verb apart?',
				answer: 'You can\'t from the word alone; ir and ser use the exact same preterite form in every person: fui for yo, fuiste for tú, fue for él/ella, fuimos for nosotros, fuisteis for vosotros, and fueron for ellos. The rest of the sentence disambiguates it: a destination or place ("fui a la tienda") means ir, while a noun, adjective, or description ("fui estudiante") means ser.',
			},
			{
				question: 'How many irregular preterite verbs are there in Spanish?',
				answer: 'There\'s no single agreed-on number, because sources draw the line in different places. Grammar references that count only verbs whose preterite stem is truly its own, the 8 u-stem verbs, the 3 i-stem verbs, decir and traer plus the open-ended -ducir family, plus the standalone pair ir/ser and the standalone pair dar/ver, land somewhere in the high teens; some study sites cite 17 on that basis. Vocabulary lists that also count the -car, -gar, -zar spelling changes, the -eer/-oír/-uir y-changes, and pedir/dormir-type verbs that only shift in él/ella and ellos forms as "irregular" push published totals past 50. This page keeps those last two groups apart from the stem-family verbs above because each follows one predictable spelling or third-person rule, not a memorized new stem, which is the more useful distinction for actually learning them, even though it makes any single headline number a matter of definition rather than fact.',
			},
		],
		sources: [
			...
			{ label: 'Spanish School Nicaragua, "Preterite: 17 Irregular Verbs in Preterite tense"', url: 'https://spanishschoolnicaragua.com/preterite/' },
			{ label: 'Spanish Academy, "50 Irregular Preterite Spanish Verbs You Want to Use Often"', url: 'https://www.spanish.academy/blog/50-irregular-preterite-spanish-verbs-you-want-to-use-often/' },
		],
	},
	{
	...
	},
	{
		...
		sections: [
			...
			},
			{
				...
				body: [
					'When a sentence needs two object pronouns at once, French doesn\'t let them fall in whatever order feels natural. In an ordinary declarative or [negative sentence](/french-negation/), they line up in a fixed sequence: me/te/se/nous/vous, then le/la/les, then lui/leur, then y, then en. Il me le donne (me before le), Il le lui donne (le before lui, since both are third person and lui drops behind), Il nous y emmène (nous before y), Il y en a (y before en, the fixed phrase "there is/are").',
	...
	},
	{
		...
		description: 'Des and der mark the genitive on the article, and masculine or neuter nouns often mark it again with their own -s — plurals and personal pronouns follow a different pattern of their own. Duden\'s own rule explains why skipping the noun\'s -s is still wrong.',
		published: '2026-08-18',
		updated: '2026-09-18',
		...
		faq: [
			{
				...
				answer: 'Ask wessen, "whose." The article gives the clearest signal: der and das both switch to des, while die switches to der, covering the feminine singular and every plural at once. A singular noun that\'s neuter or masculine goes further and adds an ending of its own, -s or -es, so des Mannes and des Kindes end up signaling the case in two places, whereas a feminine or plural noun stays exactly as it is and leaves the article to do the entire job.',
			},
			{
				question: 'How do I know whether a noun takes -s or -es in the genitive?',
				answer: 'Duden covers this split in a dedicated advice column (linked in the sources below): a sibilant ending, -ss, -z, or -tz, allows no other choice than -es, des Hasses, des Satzes; an ending of -em, -en, -er, -el, or a diminutive like -chen pulls the opposite way and takes only -s, so it\'s des Onkels and des Wagens, never a longer form. In the space left over, a wide, open zone of short nouns, Duden lets writers pick whichever ending they like, with the choice there usually coming down to placement and sound, not a fixed rule: -es wins out if the noun\'s genitive phrase comes first in its clause (des Tages Hitze), -s wins if the noun ends in a vowel or vowel+h (des Schnees).',
			},
			{
				question: 'Why is it "des Namens" and not "des Names"?',
				answer: 'Name is one of seven so-called weak masculine nouns, a group that also includes Wille, Glaube, Gedanke, Buchstabe, Friede, and Funke. All seven use a bare -n for both den and dem, but tack on an extra -s right when des shows up, so the genitive alone comes out -ns rather than plain -n: des Namens. Wille runs through the identical shift, and Duden\'s entry for the word spells out the full set: nominative der Wille, accusative den Willen, dative dem Willen, genitive des Willens.',
			},
			{
				question: 'Why is "sich Problems annehmen" wrong if Problems is genitive?',
				answer: 'It comes down to the s-Regel, the second of three parts in Duden\'s "Die Genitivregel": even a noun whose -s already signals genitive isn\'t allowed to stand by itself with nothing else, no article and no adjective, next to it. Adding one, a demonstrative like dieses, is enough on its own to turn the phrase grammatical. Duden\'s Sichtbarkeitsregel (visibility rule) sets the requirement underneath that one, coming first in the column: at least one word has to visibly carry the genitive marking before anything else applies. A third rule, the Ersatzregel (substitute rule), offers a way around the whole requirement, swapping in constructions like von plus dative instead of adding a companion word.',
			},
			{
				question: 'Is the German genitive case dying out?',
				answer: 'It\'s retreating from casual speech more than from formal writing. Everyday spoken German reaches for the dative, wegen dem Wetter, constantly, even though grammar guides continue to call the genitive, wegen des Wetters, the correct form. Während, trotz, and (an)statt, the three other prepositions from the same early-lesson set, show the same drift to a lesser degree. Bastian Sick built a 2004 bestseller title out of exactly this shift, grown out of his Spiegel Online language column and and translates roughly to "the dative is what kills off the genitive," phrased in exactly the dative-leaning grammar its own title is arguing against, rather than a stricter genitive-correct phrasing.',
			},
			{
				question: 'How is the genitive formed for plural nouns and for personal pronouns?',
				answer: 'Plural nouns sidestep the whole -s versus -es question above: der netten Eltern uses the identical noun form, Eltern, that shows up in die netten Eltern, because German attaches no extra ending to any plural noun regardless of case. All the marking work lands on der, the same article that already handles feminine singular genitives, now covering every gender at once in the plural. Personal pronouns run on a separate set built for the genitive alone, meiner, deiner, seiner, ihrer, unser, euer, ihrer/Ihrer, but outside a handful of fixed legal and literary phrases they\'ve dropped out of everyday use, and possessive adjectives have taken over the job in speech and on the page alike, mein Buch covering ground a construction on meiner used to.',
			},
		],
		sources: [
			...
			{ label: 'Duden, Deklination "Genitiv" (plural genitive noun form matches plural nominative)', url: 'https://www.duden.de/deklination/substantive/Genitiv' },
			{ label: 'Wikipedia (English), "German pronouns" (genitive personal pronoun forms and their retreat from modern usage)', url: 'https://en.wikipedia.org/wiki/German_pronouns' },
		...
		sections: [
			...
			},
			{
				...
				body: [
					...
					'Nothing about this pairing signals doubt. The present indicative in the prótasis is doing the same job it does everywhere else in Spanish, reporting something as a straightforward fact, which is exactly why real conditions never take the subjunctive: there\'s no hypothesis to mark. French\'s own conditional mood follows a parallel chronological logic in its si clauses, [pairing si with a strict sequence of tenses](/french-conditional/), though French builds its three pairings out of indicative forms throughout, where Spanish switches into the subjunctive for exactly the two less-than-certain pairings above.',
				],
			},
			{
	...
	},
	{
		...
		faq: [
			...
			},
			{
				...
				answer: 'Because the two halves of a si-sentence are locked into a strict time sequence, and that sequence blocks both the future tense and voudrais-style forms from the condition itself. Si pairs with the present (si tu viens), the imperfect (si tu venais), or the pluperfect (si tu étais venu), never with voudrais or any other conditional form. The consequence clause is the half allowed to reach for voudrais, not the si-clause itself.',
			},
			{
				question: 'Can the conditional ever follow "si" in French?',
				answer: 'Yes, in two situations. The main one is when the clause is reporting a question rather than setting up a condition, as in je me demandais si tu voudrais m\'accompagner ("I wondered whether you\'d want to come with me"). Swap in "whether" to check: if the English still reads naturally, voudrais and its relatives are allowed right after si; a sentence where only "if" fits keeps the ban in place. A second, rarer case is concessive si ("granted that..."), which also allows the future or conditional. Both exceptions are real but rarely taught alongside the base rule.',
			},
			{
				question: 'What\'s the difference between the conditional present and conditional past after "si"?',
				answer: 'Both can follow a pluperfect si-clause, but they mark different outcomes. The present-tense form (si tu avais su, tu comprendrais) describes something still possible now; the past-tense form (si elle avait révisé, elle n\'aurait pas échoué à l\'examen, "if she had studied, she wouldn\'t have failed the exam") marks an outcome that simply never occurred, what French grammar calls the irréel.',
			},
			{
				question: 'Does English "would" always translate to the French conditional?',
				answer: 'No. "Would" for a hypothetical, or for an event that was still ahead of an earlier moment in the story ("she said she would come"), maps to the conditionnel, but "would" marking a routine that kept recurring back then ("we would go every summer") maps to the imperfect instead (nous allions chaque été). Treating every English "would" as an automatic cue for the conditional produces a real, common error.',
			},
			{
		...
		sections: [
			{
				...
				body: [
					...
					'The pronunciation trips up as many people as the spelling: sē is said like "say," so per se comes out "per say," and Dictionary.com singles out "per say" as one of the more common Latin-borrowing misspellings in English precisely because the sound and the spelling pull in different directions. Other short Latin phrases keep the same kind of literal transparency once you break down the pieces: [Semper Fi](/semper-fi-meaning/) compresses semper fidelis, "always faithful," into a phrase the Marine Corps didn\'t adopt until roughly 500 years after it first turns up as a French town\'s motto.',
				],
			},
			{
		...
		sections: [
			...
			},
			{
				...
				body: [
					...
					'That absence is genuinely debated at the edges, not a clean rule RAE hands down without qualification. The academy\'s own reference grammar notes that a form like habla can\'t always be cleanly split into its three theoretical pieces; some analyses treat the ending as one fused chunk carrying all three jobs at once, others posit an unpronounced zero morpheme sitting inside it. What isn\'t in dispute is the practical upshot for a learner: unlike -aba or -é, nothing in a present-tense ending exists purely to announce "this is the present tense." The endings do that job by not adding anything extra at all. That unmarked present-tense ending is still a fully personal, conjugated form, which is exactly what separates it from [the Spanish infinitive](/spanish-infinitive/): hablar itself carries no person, tense, or mood marking whatsoever, the zero-marking idea taken to its logical endpoint rather than just one unmarked tense among several.',
				],
			},
			{
		...
		sections: [
			{
				...
				body: [
					...
					'Put the two words together and semper fidelis reads literally as "always faithful." Semper\'s "at all times" sense does real work there: the phrase describes loyalty that holds without exception or interruption. Spoken aloud, the shortened "Semper Fi" rhymes with "temper high," since Latin sē and fī both take a long-vowel "ee" and "eye" sound rather than an English-style short vowel. Institutional recognition can lag a word\'s actual age by centuries in either direction: Semper Fi waited roughly 500 years between its first recorded use and the Marine Corps\' 1883 adoption, while [maknae](/maknae-meaning/), a Korean word for a family\'s or group\'s youngest member that predates K-pop by centuries, only became an Oxford English Dictionary headword in December 2024.',
				],
				image: {
		...
		sections: [
			...
			},
			{
				...
				body: [
					...
					'As a fixed reply, native speakers don\'t consciously parse *de nada* into "of" plus "nothing" any more than English speakers stop to parse "you\'re welcome" into "you are welcome [to it]." It functions as a single social unit, learned and produced as a block, which is also why swapping in a synonym for just one half of it (like *"nada"* on its own) doesn\'t work as a substitute; the whole phrase is the unit that carries the meaning. Spanish colloquial vocabulary keeps some much rougher fixed units too: the RAE\'s own dictionary entry for [cabrón](/cabron-meaning/) lists its literal sense, "male goat," sixth out of nine, behind five vulgar or colloquial meanings that carry a completely different register than a polite reply to gracias.',
				],
			},
			{
		...
		sections: [
			...
			},
			{
				...
				body: [
					...
					'Almost every Russian preposition locks in exactly one of these cases, the way durch or für always take the accusative in German (per the German Cases guide\'s rundown of that system). Russian pushes the idea further: the same preposition can require a different case depending on what it means. V and na take the accusative when they describe motion toward a destination (v shkolu, "into the school") and the prepositional when they describe a fixed location (v shkole, "in the school"), the exact split German marks with its own separate set of two-way prepositions. Not every language solves this problem with case endings on the noun at all: [Japanese marks the same subject/object/destination roles](/japanese-particles-wa-ga-wo-ni/) with a small set of particles glued after the noun instead, wa, ga, wo, and ni doing a version of the job Russian\'s six-case system and German\'s four-case system split between endings and prepositions.',
				],
			},
			{
		...
		sections: [
			{
				...
				body: [
					...
					'This kind of gap between a word\'s literal pieces and its everyday translation shows up elsewhere in borrowed Japanese vocabulary too: [senpai](/senpai-meaning/) is another case where the component parts describe something more structured than the one-word gloss English speakers usually reach for. Japanese farewells hide a similar gap between literal pieces and everyday translation: [sayonara](/sayonara-meaning/) is glossed as a simple "goodbye," but its literal sense is closer to "if that\'s how it is," and unlike a casual arigatō, it signals a long or permanent parting rather than an everyday one.',
				],
				image: {
		...
		sections: [
			{
				...
				body: [
					...
					'The grammar underneath it is a different matter. English "what" does two jobs at once: it\'s the word you use to ask a question ("What will happen?") and, separately, a free relative pronoun standing in for "that which" ("I don\'t know what will happen" means "I don\'t know that which will happen"). Spanish and Italian split those two jobs between different words. Qué and che handle the question; neither one, on its own, can stand in for "that which." To say "that which will be, will be" the way a native speaker actually would, Spanish needs lo que será, será and Italian needs quel che sarà, sarà, with lo or quel doing the job qué and che can\'t do alone. Italian has its own well-documented loanword that, unlike this one, really is standard Italian: [ciao](/ciao-meaning/) traces to a genuine Venetian phrase, s-ciao vostro, and English absorbed both its hello and goodbye senses intact, a much cleaner borrowing than the invented-sounding grammar behind que sera sera.',
